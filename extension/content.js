      ...
      btn.onclick = async () => {
        ...
        try {
          ...
          popup.innerHTML = `
            ...
            <p style="background:#f0f0f0;padding:10px;border-radius:3px">${data.suggestion}</p>
            <button onclick="navigator.clipboard.writeText('${data.suggestion}');this.textContent='✓ Copiado!'" style="background:green;color:white;padding:5px 10px;border:none;cursor:pointer;border-radius:3px">📋 Copiar</button>
