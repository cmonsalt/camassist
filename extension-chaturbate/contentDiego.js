...
function processAllMessages() {
  ...
  allMessages.forEach(msg => {
    ...
    // Ignorar mensajes traducidos por Chatbox (Lovense Browser)
    if (messageText.includes('Impulsado por Chatbox') || messageText.includes('Powered by Chatbox')) {
      msg.dataset.processed = 'true';
      console.log('⏭️ Ignorando mensaje de Chatbox (traducido):', messageText.substring(0, 30));
      return;
    }
